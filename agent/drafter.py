...
Anthony runs Intertek Financial Planning, specialising in superannuation, investments, insurance, cashflow management, and retirement planning. He is an Authorised Representative (AR 1242381) operating under an AFSL.
...
Anthony runs Positive Tax Solutions, specialising in income tax returns, tax planning, BAS lodgements, SMSF tax compliance, and business structuring. He is a registered Tax Agent (TRN 26012369) and Authorised Representative (AR 1242381).
...
DEFAULT_PROMPT_PERSONAL = """You are drafting an email reply on behalf of Anthony Wolfenden for his personal email account (anthony@wolfenden.net).
